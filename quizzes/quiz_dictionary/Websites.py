...
quiz_questions = [
    {
        "question": "Which of these websites are safer to access?",
        "options": [
            "http://www.mystore.com/shop/shoes",
            "https://www.paypa1-secure.com/login?sessionid=1234567890",
    ...
    },
    {
        ...
        "options": [
            "Vising, Wheeling, Smoothing and Spill Phishing",
            "Spar Phising, Shearing Phishing, Vishingtin and Splashing",
    ...
    },
    {
        ...
        "options": [
            "Uses HTTPS with a padlock",
            "Has misspelled URLs or domain names",
    ...
    },
    {
        ...
        "options": [
            "It indicates the website is unsecure",
    ...
    },
    {
        ...
        "options": [
            "Identifies the server the website is hosted on",
            "Takes you to a specific section of a website",
    ...
    },
    {
        ...
        "options": [
            "Enter your information for the free offer",
    ...
    },
    {
        ...
        "options": [
            "To identify the location of a webpage on the internet",
            "To encrypt data sent between your browser and the website",
